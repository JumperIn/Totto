...
namespace MyTotto.Data.Migrations
{
    ...
    [Migration("20181202044536_AddProductProperties")]
            ...
            modelBuilder.Entity("MyTotto.Data.Models.Banner", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 2, 11, 45, 35, 516, DateTimeKind.Local));
                    ...
                    b.HasData(
                        new { Id = 1, BackgroundColor = "faffe4", Content = "При заказе на сумму от 300 рублей предоставляем бесплатную доставку в любой район Новосибирска", Created = new DateTime(2018, 12, 2, 11, 45, 35, 519, DateTimeKind.Local), ImageUrl = "/images/banner.jpg", IsActive = true, Order = 10, Title = "Бесплатная доставка" },
                        new { Id = 2, BackgroundColor = "ffffff", Content = "чтобы узнавать самым первым все последние новости и акции!", Created = new DateTime(2018, 12, 2, 11, 45, 35, 519, DateTimeKind.Local), ImageUrl = "/images/banner.jpg", IsActive = true, Order = 20, Title = "Подпишись на новости" },
                        new { Id = 3, BackgroundColor = "84cad0", Content = "Чтобы получить скидку на первый заказ необходимо зарегистрироваться и заполнить анкету первооткрывателя сайта", Created = new DateTime(2018, 12, 2, 11, 45, 35, 519, DateTimeKind.Local), ImageUrl = "/images/banner.jpg", IsActive = true, Order = 15, Title = "Скидка на первый заказ" }
                    );
                });
            ...
            modelBuilder.Entity("MyTotto.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 2, 11, 45, 35, 545, DateTimeKind.Local));
            ...
            modelBuilder.Entity("MyTotto.Data.Models.Promo", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local));
                    ...
                    b.HasData(
                        new { Id = 1, Content = "Набор из 3-х этапного ухода за кожей лица с увлажняющим эффектом", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-1.jpg", IsActive = true, Order = 10, Title = "3-х шаговая маска", Url = "/promo/akciya-1" },
                        new { Id = 2, Content = "широкий выбор патчей", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-2.jpg", IsActive = true, Order = 20, Title = "Гидрогелевые патчи", Url = "/promo/akciya-2" },
                        new { Id = 3, Content = "с экстрактом ласточкиного гнезда", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-3.jpg", IsActive = true, Order = 30, Title = "Сыворотка CF-nest 97%", Url = "/promo/akciya-3" },
                        new { Id = 4, Content = "для глубокого очищения кожи лица", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-1.jpg", IsActive = true, Order = 15, Title = "Глиняная маска", Url = "/promo/akciya-4" },
                        new { Id = 5, Content = "с экстрактом масла ши", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-2.jpg", IsActive = true, Order = 25, Title = "Маска теневая", Url = "/promo/akciya-5" },
                        new { Id = 6, Content = "для лица Aqua Hyalorunic Acid Water", Created = new DateTime(2018, 12, 2, 11, 45, 35, 521, DateTimeKind.Local), ImageUrl = "/images/discount-3.jpg", IsActive = true, Order = 35, Title = "Крем гиалуроновый", Url = "/promo/akciya-6" }
                    );
                });
            ...
            modelBuilder.Entity("MyTotto.Data.Models.PromoProduct", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 2, 11, 45, 35, 523, DateTimeKind.Local));
                    ...
                    b.HasData(
                        new { Id = 1, Content = "Введите код HAIR20 при оформлении заказа", Created = new DateTime(2018, 12, 2, 11, 45, 35, 524, DateTimeKind.Local), ImageUrl = "/images/new1.png", IsActive = true, Order = 10, Title = "Новая антивозрастная косметика", Url = "/promo/akciya-1" },
                        new { Id = 2, Content = "Волосы становятся шелковистее", Created = new DateTime(2018, 12, 2, 11, 45, 35, 524, DateTimeKind.Local), ImageUrl = "/images/new2.png", IsActive = true, Order = 20, Title = "Новинка: сыворотка от бабушки Агафьи", Url = "/promo/akciya-2" },
                        new { Id = 3, Content = "с экстрактом ласточкиного гнезда", Created = new DateTime(2018, 12, 2, 11, 45, 35, 524, DateTimeKind.Local), ImageUrl = "/images/new3.png", IsActive = true, Order = 30, Title = "Инновационная сыворотка CF-nest 97%", Url = "/promo/akciya-3" },
                        new { Id = 4, Content = "для глубокого очищения кожи лица", Created = new DateTime(2018, 12, 2, 11, 45, 35, 524, DateTimeKind.Local), ImageUrl = "/images/new4.png", IsActive = true, Order = 15, Title = "Глиняная маска", Url = "/promo/akciya-4" },
                        new { Id = 5, Content = "Огуречная маска сохранит свежесть", Created = new DateTime(2018, 12, 2, 11, 45, 35, 524, DateTimeKind.Local), ImageUrl = "/images/new1.png", IsActive = true, Order = 25, Title = "Лучшая маска всех времён", Url = "/promo/akciya-5" }
                    );
                });
