        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            (
                ...
                new Product()
                {
                    ...
                    Url = @"/katalog/category-2/subcategory-3/group-1/6",
                ...
                new Product()
                {
                    ...
                    Url = @"/katalog/category-3/subcategory-2/group-2/7",
                    ImageUrl = @"/files/products/product-7/card.jpg",
                    Price = 120.00m,
                    Discount = 0m,
                    ProductType = ProductType.Normal,
                    IsActive = true,
                    ImagesArray = new string[]
                    {
                        @"/files/products/product-7/1.jpg",
                        @"/files/products/product-7/2.jpg",
                        @"/files/products/product-7/3.jpg",
                        @"/files/products/product-7/4.jpg"
                    }
                }
            );
        }
