        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
               new Product()
               {
                   ...
                   ProductGroupId = 1,
                   TitleUrl = "esthetic-house-name-product",
                ...
                new Product()
                {
                    ...
                    ProductSubcategoryId = 1,
                    ProductGroupId = 2,
                    TitleUrl = "elizavecca-name-product",
                    ImageUrl = @"/images/cream2.png",
                    Price = 660.00m,
                    Discount = 50.0m,
                ...
                new Product()
                {
                    ...
                    ProductGroupId = 1,
                    TitleUrl = "the-saem-name-product",
                ...
                new Product()
                {
                    ...
                    ProductSubcategoryId = 1,
                    ProductGroupId = 2,
                    TitleUrl = "innisfree-name-product",
                ...
                new Product()
                {
                    ...
                    ProductSubcategoryId = 1,
                    ProductGroupId = 1,
                    TitleUrl = "farmstay-name-product",
                    ImageUrl = @"/images/cream5.png",
                    Price = 58m,
                    Discount = 0m,
                    ProductType = ProductType.Hit,
